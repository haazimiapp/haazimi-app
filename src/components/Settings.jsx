...
import { Bell, Shield, User, DollarSign, Layout as LayoutIcon, Navigation, ChevronDown } from 'lucide-react';
    ...
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100%' }}>
      ...
      <div className="form-container" style={{ maxWidth: 700, flex: 1 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          ...
          {/* 5. Customise Navigation Bar — only when bottom nav is enabled */}
          {showBottomNav && (
            <AccordionSection
              id="navbar"
