...
import { Bell, Shield, User, DollarSign, Layout as LayoutIcon, Navigation, ChevronDown, Palette } from 'lucide-react';
...
export default function Settings({ user, language, checkVisibility }) {
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      padding: '10px 14px', border: `2px solid ${selected ? th.accent : 'var(--border-color)'}`,
