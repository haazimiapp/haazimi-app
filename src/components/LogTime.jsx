...
import { MapPin, Pencil, Trash2, X, Share2, Mail } from 'lucide-react';
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                  ...
                  <div className="form-group" style={{ margin: 0 }}>
                    ...
                    <select value={form.activity} onChange={handleActivityChange}>
                      {Object.keys(t.activities || { Teaching: 1, Admin: 1, 'Teaching + Admin': 1, 'Exam Supervision': 1, Meeting: 1, Planning: 1, Other: 1 }).map(key => (
