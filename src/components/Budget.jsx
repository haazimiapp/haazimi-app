  ...
  return (
    <div>
      ...
      <div className="dashboard-grid" style={{ marginBottom: 30 }}>
        {[
          { label: 'Total Budget', value: `PKR ${totalBudgeted.toLocaleString()}`, color: 'var(--accent-color)' },
          { label: 'Total Spent', value: `PKR ${totalSpent.toLocaleString()}`, color: 'var(--warning-color)' },
          { label: 'Remaining', value: `PKR ${remaining.toLocaleString()}`, color: remaining >= 0 ? 'var(--success-color)' : 'var(--danger-color)' },
      ...
      <div className="table-container">
        ...
        <table className="staff-table budget-table">
          <thead>
            <tr>
              <th>Category</th>
              <th>Budgeted (PKR)</th>
