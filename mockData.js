export const USERS = [
  { id: 1, name: 'Admin User', role: 'manager', center: 'Head Office', email: 'admin@ims.org', password: 'admin' },
  { id: 2, name: 'Ahmad Ali', role: 'dhimmedaar', center: 'Branch A', email: 'ahmad@ims.org', password: '1234' },
  { id: 3, name: 'Yusuf Khan', role: 'dhimmedaar', center: 'Branch B', email: 'yusuf@ims.org', password: '1234' },
];

export const STAFF = [
  { id: 1, name: 'Ahmad Ali', role: 'Teacher', center: 'Branch A', status: 'Active', phone: '0300-1234567', joinDate: '2022-01-15', leaves: 3 },
  { id: 2, name: 'Bilal Hassan', role: 'Admin', center: 'Head Office', status: 'Active', phone: '0311-9876543', joinDate: '2021-06-01', leaves: 1 },
  { id: 3, name: 'Fatima Malik', role: 'Teacher', center: 'Branch B', status: 'Active', phone: '0321-5556789', joinDate: '2023-03-20', leaves: 0 },
  { id: 4, name: 'Usman Tariq', role: 'Teacher', center: 'Branch A', status: 'On Leave', phone: '0333-4445678', joinDate: '2020-09-10', leaves: 7 },
  { id: 5, name: 'Zainab Raza', role: 'Coordinator', center: 'Head Office', status: 'Active', phone: '0345-2223456', joinDate: '2022-11-05', leaves: 2 },
  { id: 6, name: 'Ibrahim Shah', role: 'Teacher', center: 'Branch C', status: 'Active', phone: '0312-7778901', joinDate: '2023-07-01', leaves: 0 },
  { id: 7, name: 'Khadija Noor', role: 'Teacher', center: 'Branch B', status: 'Inactive', phone: '0322-1112345', joinDate: '2019-04-15', leaves: 12 },
];
...
export const EVENTS = [
  ...
  { date: '2026-04-05', type: 'event', name: 'Guest Scholar Visit', desc: 'Sheikh Abdullah Al-Farsi visiting' },
...
export const PEOPLE_TO_VISIT = [
  ...
  { id: 4, name: 'Sheikh Abdullah', relation: 'Community Leader', student: null, area: 'Saddar', dueDate: '2026-04-01', lastVisit: '2026-02-15', status: 'upcoming', notes: 'Partnership discussion.' },
